...
2. Version Major - Used to identify the exact version of sga archive. For SGA V4, it should always be 5. 
3. Version Minor - Sometimes called platform. Indemnify the patch version of the SGA archive.
...
8. TOC offset - The starting position of the table of contents.
9. Unknown1 - Unknown value, but is always 1.
10. Unknown2 - Unknown value, but is always 0.
11. Unknown3 - Unknown value, Seems to be only random padding on the end of the archive header.
...
6. Modified - Linux timestamp when the file was changed.
7. Unused - unused in this version of the SGA archive.
8. Storage type - type of compression used. 
